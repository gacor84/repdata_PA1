...
```{r act2.days (weekdays),fig.width=13}
act2.days<-act2
...
```{r act3 (weekdays/weekends),fig.width=13}
act3<-act2.days
...
```{r act3 ts.plot weekdays/weekends}
